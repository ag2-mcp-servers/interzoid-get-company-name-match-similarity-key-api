...
#   timestamp: 2025-06-29T03:48:47+00:00
...
from models import GetcompanymatchGetResponse
...
@app.get(
    ...
    tags=['company_name_matching', 'company_data_comparison'],
)
def getcompanymatch(license: str, company: str = ...):
    """
